...
EFI Resolver now supports PEI files as well. The plugin supports PPIs defined in core UEFI specification, for vendor protocols/PPIs, it can automatically rename the GUID (no type information).
